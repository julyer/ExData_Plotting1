...
# create the graphs and create png in working directory
...
plot(februaryData$dateTime, februaryData$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

plot(februaryData$dateTime, februaryData$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
