...
# create the histogram and create png in working directory

png("Plot1.png", width = 480, height = 480, units = "px")

hist(februaryData$Global_active_power, main = "Global Active Power", col = "red", xlab = "Global Active Power (kilowatts)", ylab = "Frequency")
